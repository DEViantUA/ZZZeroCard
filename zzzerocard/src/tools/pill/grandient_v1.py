...
from .color_control import light_level, get_light_pixel_color, get_dark_pixel_color
...
class GradientGenerator:
    ...
    async def generate(self, width, height, left = False):
        ...
        if ll < 45:
            ...
            top_color = await get_dark_pixel_color(top_color)
        ...
        if ll < 45:
            ...
            center_color = await get_dark_pixel_color(center_color)
        ...
        if ll < 45:
            ...
            bottom_color = await get_dark_pixel_color(bottom_color)
